...
__chart.html__
chart.html is a simple website that takes a .json generated by parse.js and uses a graphing script to quickly show the data on a chart.
This mainly exists to show that the data can be retrieved easily from the .json and as an example of graphing things in HTML/Javascript. Future CS students may want to reference this to integrate it into ADAS.